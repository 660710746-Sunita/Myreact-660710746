...
const TodoList = () => {
    ...
    const todos = [
        ...
        { id: 3, text: 'ทบทวนวิชา DBA', completed: false },
        { id: 4, text: 'ทบทวนวิชา BIS', completed: true },
        { id: 5, text: 'ทบทวนวิชา AI', completed: false },
        { id: 6, text: 'ทบทวนวิชา BE', completed: true },
        { id: 7, text: 'ทบทวนวิชา FE', completed: false }
    ];
